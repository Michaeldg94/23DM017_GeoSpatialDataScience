...
by mccode: egen pdatmean = mean(pdat)
by mccode: egen psimmean = mean(psim)
sort obs

reg pdat psim, cluster(mccode)

gen pdatdemean = pdat - pdatmean
gen psimdemean = psim - psimmean

contract mccode pdatmean psimmean obs
correlate pdatmean psimmean
