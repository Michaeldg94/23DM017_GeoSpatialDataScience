...
execute 'gdxxrw.exe resultsmod.gdx o=resultsALLcfSRNEW.xlsx par=p rng="p!a1:ed512" cdim=1 rdim=2'
execute 'gdxxrw.exe resultsmod.gdx o=resultsALLcfSRNEW.xlsx par=q rng="q!a1:ed512" cdim=1 rdim=2'
execute 'gdxxrw.exe resultsmod.gdx o=resultsALLcfSRNEW.xlsx par=flag rng=flag!a1 cdim=1 rdim=2'
execute 'gdxxrw.exe resultsmod.gdx o=resultsALLcfSRNEW.xlsx par=flag2 rng=flag2!a1 cdim=1 rdim=2'
