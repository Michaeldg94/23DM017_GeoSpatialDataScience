...
model africa6W46_MCP / quantity.p, price.q , storagenoarb.s, tradenoarb.tr/;

africa6W46_MCP.optfile = 1;

solve africa6W46_MCP using MCP ;

execute_unload "results6W46" s.l p.l q.l;
execute_unload "resultstr6W46" tr.l;
execute 'gdxxrw.exe results6W46.gdx o=results6W46.xlsx var=s.l rng=s!a2:bi520'
execute 'gdxxrw.exe results6W46.gdx o=results6W46.xlsx var=s.l rng=s0!a1'
execute 'gdxxrw.exe results6W46.gdx o=results6W46.xlsx var=p.l rng=p!a2:bj520'
execute 'gdxxrw.exe results6W46.gdx o=results6W46.xlsx var=q.l rng=q!a2:bj520'
execute 'gdxxrw.exe resultstr6W46.gdx o=results6W46.xlsx var=tr.l rng=tr!a2:bk1000'
