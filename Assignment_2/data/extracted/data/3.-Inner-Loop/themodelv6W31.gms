...
model africa6W31_MCP / quantity.p, price.q , storagenoarb.s, tradenoarb.tr/;

africa6W31_MCP.optfile = 1;

solve africa6W31_MCP using MCP ;

execute_unload "results6W31" s.l p.l q.l;
execute_unload "resultstr6W31" tr.l;
execute 'gdxxrw.exe results6W31.gdx o=results6W31.xlsx var=s.l rng=s!a2:bi520'
execute 'gdxxrw.exe results6W31.gdx o=results6W31.xlsx var=s.l rng=s0!a1'
execute 'gdxxrw.exe results6W31.gdx o=results6W31.xlsx var=p.l rng=p!a2:bj520'
execute 'gdxxrw.exe results6W31.gdx o=results6W31.xlsx var=q.l rng=q!a2:bj520'
execute 'gdxxrw.exe resultstr6W31.gdx o=results6W31.xlsx var=tr.l rng=tr!a2:bk1000'
