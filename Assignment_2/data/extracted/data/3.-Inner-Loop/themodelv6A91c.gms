...
$call gdxxrw i=EP44d.xlsx o=imp_varmt1.gdx par=imp_varmt1 rng="EP30!a1:ec230" cdim=1 rdim=1
$gdxin imp_varmt1.gdx
$load imp_varmt1
Pop(m,t) = imp_varmt1(m,t);

$call gdxxrw i=EH44d.xlsx o=imp_varmct.gdx par=imp_varmct rng="EH30!a1:ed1375" cdim=1 rdim=2
...
$call gdxxrw i=results6A90in.xlsx o=imp_vars0.gdx par=imp_vars0 rng="s0!a1:c400" cdim=1 rdim=2
$gdxin imp_vars0.gdx
$load imp_vars0
...
$call gdxxrw i=in_pint.xlsx o=imp_pint.gdx par=imp_pint rng="PI91!a1:ed6" cdim=1 rdim=2
$gdxin imp_pint.gdx
$load imp_pint
...
$call gdxxrw i=results6SEH91.xlsx o=imp_pinSE.gdx par=imp_pinSE rng="p!a2:bj300" cdim=1 rdim=2
$gdxin imp_pinSE.gdx
$load imp_pinSE
$call gdxxrw i=results6SEH91.xlsx o=imp_qinSE.gdx par=imp_qinSE rng="q!a2:bj300" cdim=1 rdim=2
$gdxin imp_qinSE.gdx
$load imp_qinSE
$call gdxxrw i=results6SEH91.xlsx o=imp_sinSE.gdx par=imp_sinSE rng="s!a2:bj300" cdim=1 rdim=2
$gdxin imp_sinSE.gdx
$load imp_sinSE
$call gdxxrw i=results6SEH91.xlsx o=imp_trinSE.gdx par=imp_trinSE rng="tr!a2:bk600" cdim=1 rdim=3
$gdxin imp_trinSE.gdx
$load imp_trinSE

$call gdxxrw i=results6W91.xlsx o=imp_pinWH.gdx par=imp_pinWH rng="p!a2:bj335" cdim=1 rdim=2
$gdxin imp_pinWH.gdx
$load imp_pinWH
$call gdxxrw i=results6W91.xlsx o=imp_qinWH.gdx par=imp_qinWH rng="q!a2:bj335" cdim=1 rdim=2
$gdxin imp_qinWH.gdx
$load imp_qinWH
$call gdxxrw i=results6W91.xlsx o=imp_sinWH.gdx par=imp_sinWH rng="s!a2:bj335" cdim=1 rdim=2
$gdxin imp_sinWH.gdx
$load imp_sinWH
$call gdxxrw i=results6W91.xlsx o=imp_trinWH.gdx par=imp_trinWH rng="tr!a2:bk500" cdim=1 rdim=3
...
model africa6A91_MCP / quantity.p, price.q , storagenoarb.s, tradenoarb.tr/;

africa6A91_MCP.optfile = 1;

solve africa6A91_MCP using MCP ;

execute_unload "results6A91" s.l p.l q.l;
execute_unload "resultstr6A91" tr.l;
execute 'gdxxrw.exe results6A91.gdx o=results6A91.xlsx var=s.l rng=s!a2:bi520'
execute 'gdxxrw.exe results6A91.gdx o=results6A91.xlsx var=s.l rng=s0!a1'
execute 'gdxxrw.exe results6A91.gdx o=results6A91.xlsx var=p.l rng=p!a2:bj520'
execute 'gdxxrw.exe results6A91.gdx o=results6A91.xlsx var=q.l rng=q!a2:bj520'
execute 'gdxxrw.exe resultstr6A91.gdx o=results6A91.xlsx var=tr.l rng=tr!a2:bk1000'
...
execute_unload "results6A91in" storin pricin quanin;
execute_unload "resultstr6A91in" tradin;
execute_unload "resultsS06A91in" s0in;
execute 'gdxxrw.exe results6A91in.gdx o=results6A91in.xlsx par=storin rng=s!a1 cdim=1 rdim=2'
execute 'gdxxrw.exe resultsS06A91in.gdx o=results6A91in.xlsx par=s0in rng=s0!a1 cdim=1 rdim=2'
execute 'gdxxrw.exe results6A91in.gdx o=results6A91in.xlsx par=pricin rng=p!a1 cdim=1 rdim=2'
execute 'gdxxrw.exe results6A91in.gdx o=results6A91in.xlsx par=quanin rng=q!a1 cdim=1 rdim=2'
execute 'gdxxrw.exe resultstr6A91in.gdx o=results6A91in.xlsx par=tradin rng=tr!a1 cdim=1 rdim=3'
