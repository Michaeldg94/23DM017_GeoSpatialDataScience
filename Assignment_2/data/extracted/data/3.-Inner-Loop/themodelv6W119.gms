...
model africa6W119_MCP / quantity.p, price.q , storagenoarb.s, tradenoarb.tr/;

africa6W119_MCP.optfile = 1;

solve africa6W119_MCP using MCP ;

execute_unload "results6W119" s.l p.l q.l;
execute_unload "resultstr6W119" tr.l;
execute 'gdxxrw.exe results6W119.gdx o=results6W119.xlsx var=s.l rng=s!a2:bi520'
execute 'gdxxrw.exe results6W119.gdx o=results6W119.xlsx var=s.l rng=s0!a1'
execute 'gdxxrw.exe results6W119.gdx o=results6W119.xlsx var=p.l rng=p!a2:bj520'
execute 'gdxxrw.exe results6W119.gdx o=results6W119.xlsx var=q.l rng=q!a2:bj520'
execute 'gdxxrw.exe resultstr6W119.gdx o=results6W119.xlsx var=tr.l rng=tr!a2:bk1000'
...
execute_unload "results6W119in" storin pricin quanin;
execute_unload "resultstr6W119in" tradin;
execute_unload "resultsS06W119in" s0in;
execute 'gdxxrw.exe results6W119in.gdx o=results6W119in.xlsx par=storin rng=s!a1 cdim=1 rdim=2'
execute 'gdxxrw.exe resultsS06W119in.gdx o=results6W119in.xlsx par=s0in rng=s0!a1 cdim=1 rdim=2'
execute 'gdxxrw.exe results6W119in.gdx o=results6W119in.xlsx par=pricin rng=p!a1 cdim=1 rdim=2'
execute 'gdxxrw.exe results6W119in.gdx o=results6W119in.xlsx par=quanin rng=q!a1 cdim=1 rdim=2'
execute 'gdxxrw.exe resultstr6W119in.gdx o=results6W119in.xlsx par=tradin rng=tr!a1 cdim=1 rdim=3'
