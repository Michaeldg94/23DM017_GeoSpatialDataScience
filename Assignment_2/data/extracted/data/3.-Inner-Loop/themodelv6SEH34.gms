$title THE model version 6SEH34
$offupper
$onuellist
...
$call gdxxrw i=results6A33in.xlsx o=imp_pin.gdx par=imp_pin rng="p!a1:bj512" cdim=1 rdim=2
$gdxin imp_pin.gdx
$load imp_pin
$call gdxxrw i=results6A33in.xlsx o=imp_qin.gdx par=imp_qin rng="q!a1:bj512" cdim=1 rdim=2
$gdxin imp_qin.gdx
$load imp_qin
$call gdxxrw i=results6A33in.xlsx o=imp_sin.gdx par=imp_sin rng="s!a1:bi512" cdim=1 rdim=2
$gdxin imp_sin.gdx
$load imp_sin
$call gdxxrw i=results6A33in.xlsx o=imp_trin.gdx par=imp_trin rng="tr!a1:bk1000" cdim=1 rdim=3
$gdxin imp_trin.gdx
$load imp_trin
...
model africa6SEH34_MCP / quantity.p, price.q , storagenoarb.s, tradenoarb.tr/;

africa6SEH34_MCP.optfile = 1;

solve africa6SEH34_MCP using MCP ;

execute_unload "results6SEH34" s.l p.l q.l;
execute_unload "resultstr6SEH34" tr.l;
execute 'gdxxrw.exe results6SEH34.gdx o=results6SEH34.xlsx var=s.l rng=s!a2:bi520'
execute 'gdxxrw.exe results6SEH34.gdx o=results6SEH34.xlsx var=s.l rng=s0!a1'
execute 'gdxxrw.exe results6SEH34.gdx o=results6SEH34.xlsx var=p.l rng=p!a2:bj520'
execute 'gdxxrw.exe results6SEH34.gdx o=results6SEH34.xlsx var=q.l rng=q!a2:bj520'
execute 'gdxxrw.exe resultstr6SEH34.gdx o=results6SEH34.xlsx var=tr.l rng=tr!a2:bk1000'
