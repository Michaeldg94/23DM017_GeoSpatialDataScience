$title THE model version 6SEH119
$offupper
$onuellist
...
$call gdxxrw i=results6A118in.xlsx o=imp_pin.gdx par=imp_pin rng="p!a1:bj512" cdim=1 rdim=2
$gdxin imp_pin.gdx
$load imp_pin
$call gdxxrw i=results6A118in.xlsx o=imp_qin.gdx par=imp_qin rng="q!a1:bj512" cdim=1 rdim=2
$gdxin imp_qin.gdx
$load imp_qin
$call gdxxrw i=results6A118in.xlsx o=imp_sin.gdx par=imp_sin rng="s!a1:bi512" cdim=1 rdim=2
$gdxin imp_sin.gdx
$load imp_sin
$call gdxxrw i=results6A118in.xlsx o=imp_trin.gdx par=imp_trin rng="tr!a1:bk1000" cdim=1 rdim=3
$gdxin imp_trin.gdx
$load imp_trin
...
model africa6SEH119_MCP / quantity.p, price.q , storagenoarb.s, tradenoarb.tr/;

africa6SEH119_MCP.optfile = 1;

solve africa6SEH119_MCP using MCP ;

execute_unload "results6SEH119" s.l p.l q.l;
execute_unload "resultstr6SEH119" tr.l;
execute 'gdxxrw.exe results6SEH119.gdx o=results6SEH119.xlsx var=s.l rng=s!a2:bi520'
execute 'gdxxrw.exe results6SEH119.gdx o=results6SEH119.xlsx var=s.l rng=s0!a1'
execute 'gdxxrw.exe results6SEH119.gdx o=results6SEH119.xlsx var=p.l rng=p!a2:bj520'
execute 'gdxxrw.exe results6SEH119.gdx o=results6SEH119.xlsx var=q.l rng=q!a2:bj520'
execute 'gdxxrw.exe resultstr6SEH119.gdx o=results6SEH119.xlsx var=tr.l rng=tr!a2:bk1000'
...
execute_unload "results6SEH119in" storin pricin quanin;
execute_unload "resultstr6SEH119in" tradin;
execute_unload "resultsS06SEH119in" s0in;
execute 'gdxxrw.exe results6SEH119in.gdx o=results6SEH119in.xlsx par=storin rng=s!a1 cdim=1 rdim=2'
execute 'gdxxrw.exe resultsS06SEH119in.gdx o=results6SEH119in.xlsx par=s0in rng=s0!a1 cdim=1 rdim=2'
execute 'gdxxrw.exe results6SEH119in.gdx o=results6SEH119in.xlsx par=pricin rng=p!a1 cdim=1 rdim=2'
execute 'gdxxrw.exe results6SEH119in.gdx o=results6SEH119in.xlsx par=quanin rng=q!a1 cdim=1 rdim=2'
execute 'gdxxrw.exe resultstr6SEH119in.gdx o=results6SEH119in.xlsx par=tradin rng=tr!a1 cdim=1 rdim=3'
